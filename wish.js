...
console.log("bagobject",bagitemobject)
...
function onload(){
 ...
 function displaybagitem(){
    ...
    let wishcontainerelement=document.querySelector(".maincontainer")
    wishcontainerelement.innerHTML='';



}
function generatewishItemhtml(item){
